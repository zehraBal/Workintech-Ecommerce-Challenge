...
export default function Footer() {
  return (
    <footer className="w-screen flex flex-col mt-40px items-center">
      <div className="w-full flex justify-center items-center  px-[100px] py-[40px] sm:flex-col sm:justify-start sm:items-start sm:[414px] sm:p-0 sm:pl-12">
        <div className="w-[85%] flex justify-between items-center sm:w-[414px] sm:flex-col">
      ...
      <div className="w-[85%] flex justify-between py-[50px] px-[100px] flex-wrap sm:flex-col sm:gap-[30px] sm:w-[414px] sm:pl-12">
      ...
      <div className="w-full flex items-center justify-center leading-6 font-bold py-[25px] bg-[#FAFAFA] text-[#737373] sm:w-[414px] sm:pl-12">
        <div className="w-[85%]">
