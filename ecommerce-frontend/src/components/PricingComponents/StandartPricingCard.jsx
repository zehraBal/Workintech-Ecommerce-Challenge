...
export default function StandartPricingCard({ isYearly }) {
  return (
    <div className="w-[327px] h-[704px] bg-[#252B42] text-white pricing-border flex flex-col items-center justify-evenly">
      <h3>STANDART</h3>
      ...
      {/*list*/}
      <div className="flex flex-col items-stretch w-[247px] h-[236px] gap-4 font-bold text-sm leading-6 text-white">
